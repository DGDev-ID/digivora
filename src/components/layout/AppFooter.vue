  ...
  <footer style="background-color: #0A1110; border-top: 1px solid rgba(0,191,166,0.1);">
    ...
    <div class="max-w-7xl mx-auto px-6 py-20">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
        ...
        <!-- Services -->
        <div>
          <h4 class="text-xs font-bold tracking-[0.3em] uppercase mb-6" style="color: rgba(0,191,166,0.6);">Services</h4>
        ...
        <!-- Navigation -->
        <div>
          <h4 class="text-xs font-bold tracking-[0.3em] uppercase mb-6" style="color: rgba(0,191,166,0.6);">Navigation</h4>
          <ul class="flex flex-col gap-3">
        ...
        <!-- Contact -->
        <div>
          <h4 class="text-xs font-bold tracking-[0.3em] uppercase mb-6" style="color: rgba(0,191,166,0.6);">Contact</h4>
    ...
    <div class="px-6 py-6" style="border-top: 1px solid rgba(0,191,166,0.06);">
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
        <p class="text-xs" style="color: rgba(229,231,235,0.2);">
          © 2026 Digivora Solution Technology. All rights reserved.
        </p>
